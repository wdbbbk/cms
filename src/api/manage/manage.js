...
//按需查询vip信息
export const queryVip = async (value)=>{
  let res = await axios.post('/cms/Vipmanage/queryVip',
    {value}
  )
  return(res)
}
