...
router.post('/pcareadd',(req,res)=>{
    const {shop,bigclass,smallclass,name,barcode,price,sallprice,cleandifficulty,Productnumber} = req.body
    console.log(shop,bigclass,smallclass,name,barcode,price,sallprice,cleandifficulty,Productnumber)
    Petfoster.insertMany({shop,bigclass,smallclass,name,barcode,price,sallprice,cleandifficulty,Productnumber})
    .then((data)=>{
        console.log(data)
